...
function OurStory() {
  ...
  return (
    <div className="w-full h-[550px] xxs:h-[540px] lg:h-[515px] flex flex-row">
      <div className="text-left w-[90%] h-[full] mdlg:w-[55%]">
        <img src={doraImg} alt="" />
      </div>
      <div className="w-[50%]  lg:w-[38%] font-lato text-base mt-[150px] xs:mt-[160px] sm:mt-[210px] md:mt-[230px] md:ml-[-190px] ml-[-150px] mdlg:ml-0 mdlg:mt-[100px] mdlg:w-[40%] pr-[25px]">
